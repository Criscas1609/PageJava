...
<header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <nav class="my-2 my-md-0 me-md-3"><a class="p-2 text-dark" href="#">Productos</a>
        <form action="${pageContext.request.contextPath}/SvProducts" method="GET">
            <button type="submit" name="cart" class="my-2 my-md-0 me-md-3">Carrito</button>
        </form>
        <a class="p-2 text-dark" href="/index.jsp">Salir</a>
    </nav>
</header>
